...
export interface YourCollectibleInterface extends utils.Interface {
  ...
  events: {
    ...
    "CreatedNFT(uint256)": EventFragment;
...
export type CreatedNFTEvent = TypedEvent<[BigNumber], { tokenId: BigNumber }>;
...
export interface YourCollectible extends BaseContract {
  ...
  callStatic: {
    ...
    mintItem(_svg: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    "CreatedNFT(uint256)"(tokenId?: BigNumberish | null): CreatedNFTEventFilter;
    CreatedNFT(tokenId?: BigNumberish | null): CreatedNFTEventFilter;
