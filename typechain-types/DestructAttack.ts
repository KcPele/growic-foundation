...
export interface DestructAttackInterface extends utils.Interface {
  contractName: "DestructAttack";
  functions: {
...
export interface DestructAttack extends BaseContract {
  contractName: "DestructAttack";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DestructAttackInterface;
