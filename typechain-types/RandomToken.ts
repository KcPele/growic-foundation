...
export interface RandomTokenInterface extends utils.Interface {
  contractName: "RandomToken";
  functions: {
...
export interface RandomToken extends BaseContract {
  contractName: "RandomToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RandomTokenInterface;
